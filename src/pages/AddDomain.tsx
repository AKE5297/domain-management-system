...
export default function AddDomain() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const domains: DomainInfo[] = savedDomains ? JSON.parse(savedDomains) : [];
  ...
  return (
     <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      {/* 侧边栏 */}
      {sidebarOpen && (
        <Sidebar onLogout={logout} currentPage="/domains/add" />
      )}
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">添加新域名</h1>
            <p className="text-gray-500 dark:text-gray-400">填写域名信息以添加到您的域名列表中</p>
          </div>
          ...
          {/* 提示信息 */}
          <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50 rounded-lg p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700 dark:text-blue-400">
                  <ul className="list-disc pl-5 space-y-1">
                    <li>请确保输入正确的域名格式，例如 example.com</li>
                    <li>到期日期必须晚于购买日期</li>
                    <li>添加后，系统将自动计算域名状态（活跃、即将到期或已过期）</li>
                  </ul>
                </div>
              </div>
            </div>
